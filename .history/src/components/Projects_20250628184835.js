...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "ChatterBot",
      description: "Built scalable LLM solution using RayServe and VLLM with FastAPI for optimized performance and real-time inference.",
      technologies: ["Python", "LLM", "FastAPI", "RayServe", "VLLM"],
